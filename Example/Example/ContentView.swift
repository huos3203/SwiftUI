...
struct ContentView : View {
    ...
    let listData:[SectionModel] = sectionData
    
    var body: some View {
        NavigationView {
            List {
              /*
                ForEach(listData){ secM in

                    Section(header: Text(secM.title)) {
                        NavigationLink(destination: WebViewPage()) {
                            PageRow(title: "WebView", subTitle: "用于展示一个打开的网页")
                        }
//                        ForEach(secM.rowArr){ rowM in
//                            NavigationLink(destination: rowM.toPage) {
//                                PageRow(title: rowM.title, subTitle: rowM.subtitle)
//                           }
//                        }
...
let sectionData:[SectionModel] = [
    SectionModel(title: "特殊视图", rowArr: [
        RowModel(title: "WebView", subTitle: "用于展示一个打开的网页", toPage: WebViewPage()),
        RowModel(title: "UIViewController", subTitle: "打开 UIViewController", toPage: ControllerPage<UIKitController>())
    ]),
    SectionModel(title: "基础控件", rowArr: [
        RowModel(title: "Text", subTitle: "显示一行或多行只读文本", toPage: TextPage()),
        RowModel(title: "TextField", subTitle: "显示可编辑文本界面的输入控件", toPage: TextFieldPage()),
        RowModel(title: "SecureField", subTitle: "安全输入私密文本的输入控件", toPage: TextFieldPage()),
        RowModel(title: "Image", subTitle: "用以展示本地图片", toPage: ImagePage()),
        RowModel(title: "WebImage", subTitle: "下载网络图片并展示", toPage: WebImagePage())
    ]),
    SectionModel(title: "按钮", rowArr: [
        RowModel(title: "Button", subTitle: "触发时执行操作的按钮", toPage: ButtonPage()),
        RowModel(title: "NavigationButton", subTitle: "按下时触发导航跳转的按钮", toPage: NavigationButtonPage()),
        RowModel(title: "PresentationButton", subTitle: "触发时显示内容的按钮控件", toPage: Text("I'm Text")),
        RowModel(title: "EditButton", subTitle: "用于切换当前编辑模式的按钮", toPage: EditButtonPage())
    ]),
    SectionModel(title: "选择器", rowArr: [
        RowModel(title: "Picker", subTitle: "可自定义数据源的 Picker 选择器", toPage: PickerPage()),
        RowModel(title: "DatePicker", subTitle: "日期展示与选择", toPage: DatePickerPage()),
        RowModel(title: "Toggle", subTitle: "开关状态切换", toPage: TogglePage()),
        RowModel(title: "Slider", subTitle: "用以设置指定范围内的值", toPage: SliderPage()),
        RowModel(title: "Stepper", subTitle: "用以增加或减少数值", toPage: StepperPage())
    ]),
    SectionModel(title: "布局", rowArr: [
        RowModel(title: "HStack", subTitle: "将子视图排列在水平线上的视图", toPage: HStackPage()),
        RowModel(title: "VStack", subTitle: "将子视图排列在垂直线上的视图", toPage: VStackPage()),
        RowModel(title: "ZStack", subTitle: "覆盖子视图，在两轴上对齐", toPage: ZStackPage()),
        RowModel(title: "List", subTitle: "列表容器，用以显示一列数据", toPage: ListPage()),
        RowModel(title: "ScrollView", subTitle: "滚动视图", toPage: ScrollViewPage()),
        RowModel(title: "ForEach", subTitle: "用于根据已有数据的集合展示视图", toPage: ForEachPage()),
        RowModel(title: "Group", subTitle: "用于集合多个视图，对 Group 设置的属性，将作用于每个子视图", toPage: GroupPage()),
        RowModel(title: "Section", subTitle: "用于创建带头/尾部的视图内容，一般结合 `List` 组件使用", toPage: SectionPage())
    ]),
    SectionModel(title: "导航视图", rowArr: [
        RowModel(title: "NavigationView", subTitle: "用于创建包含顶部导航栏的视图容器", toPage: NavigationViewPage()),
        RowModel(title: "TabBar", subTitle: "用于创建包含底部 TabBar 的视图容器", toPage: TableViewPage())
    ]),
    SectionModel(title: "Alert弹框视图", rowArr: [
        RowModel(title: "Alert", subTitle: "展示一个弹框提醒", toPage: AlertPage()),
        RowModel(title: "ActionSheet", subTitle: "弹出一个选择框", toPage: ActionSheetPage()),
        RowModel(title: "Modal", subTitle: "Modal 弹出一个视图", toPage: ModalPage()),
        RowModel(title: "Popover", subTitle: "Pop 弹出一个视图", toPage: PopoverPage())
    ])
]
